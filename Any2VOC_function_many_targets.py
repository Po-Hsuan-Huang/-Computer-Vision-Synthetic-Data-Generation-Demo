...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 18:15:55 2017
...
def VOCxml(filename, image_obj, classlabel_list, img_pos_list, text_pos_list, text_space_list, font_type ):
    '''
        filename : str
            name of the file
    ...
    # annotation of target images
    for i in range(num_target):
    
        img_pos = img_pos_list[i]
        text_pos = text_pos_list[i]
        classlabel = classlabel_list[i]
        text_space = text_space_list[i]
